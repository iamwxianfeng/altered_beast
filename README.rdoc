...
=== INSTALLATION
    ...
    $ rake db:schema:load
    $ rails c
      site= Site.new({name: "weiyi",host: "localhost"})
      site.save
      user = User.new({login: "admin",email: "iamwxianfeng@qq.com",password: "123456",password_confirmation: "123456",admin: true,state: "active",site_id: site.id})
